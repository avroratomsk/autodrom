(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".catalog-home__slider")) new swiper_core_Swiper(".catalog-home__slider", {
        ...
        if (document.querySelector(".swiper-stock")) new swiper_core_Swiper(".swiper-stock", {
        ...
        if (document.querySelector(".service-slider__slider")) new swiper_core_Swiper(".service-slider__slider", {
            modules: [ Navigation, Pagination, Pagination, Autoplay ],
            direction: "horizontal",
            effect: "slide",
            slidesPerView: 1,
